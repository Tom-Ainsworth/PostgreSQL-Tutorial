...
tom_ainsworth = Programmer(
    first_name="Tom",
    last_name="Ainsworth",
    gender="M",
    nationality="British",
    famous_for="Toms Drum Lessons"
)
...
session.add(pacman)
session.add(pokemon)
session.add(splinter_cell)
session.add(sonic)

# commit the new records to the "game" table
session.commit()